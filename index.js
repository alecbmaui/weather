...
app.post("/", function(req, res) {
    ...
    https.get(url, function(response){
        ...
        response.on("data", function(data){
            ...
            res.write("<h2>The Temperature in " + city + " " + cityID + " is " + temp + " Degrees Fahrenheit<h2>" + "<h3> The humidity is " + humid + "% and the wind speed is " + wind + "mph<h3>" + " with a cloudiness of " + clouds + "%");
